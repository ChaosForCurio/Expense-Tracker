        ...
        <div className="min-h-screen bg-[#0f172a] flex flex-col justify-center items-center p-6 relative overflow-hidden">
            ...
            <div className="max-w-md w-full z-10">
                ...
                <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <p className="text-slate-400 text-lg mb-2">Join for financial clarity</p>
                    <p className="text-sm text-slate-500">Create your account to start tracking</p>
                </div>

                {/* Stack Auth SignUp Component with Custom Styling */}
                ...
                <div className="mt-8 text-center animate-in fade-in duration-1000 delay-300">
                    <p className="text-slate-500 text-sm">
                        Secure registration powered by Stack Auth
                    </p>
                </div>
            </div>
